/****************************************************************************
** Meta object code from reading C++ file 'qml_mediator.h'
**
...
#include "../../../src/test5/include/qml_mediator.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'qml_mediator.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(5, 40, 13), // "newStringSlot"
QT_MOC_LITERAL(6, 54, 7) // "strings"

    },
    "QMLMediator\0stringsChanged\0\0newString\0"
    "s\0newStringSlot\0strings"
};
...
void QMLMediator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->newStringSlot((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QMLMediator::stringsChanged)) {
                *result = 0;
            }
        }
        {
...
const QMetaObject QMLMediator::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QMLMediator.data,
      qt_meta_data_QMLMediator,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QMLMediator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QMLMediator.stringdata0))
        return static_cast<void*>(const_cast< QMLMediator*>(this));
...
// SIGNAL 0
void QMLMediator::stringsChanged()
{
